...
urlpatterns = [
 ...
 #   path('create_2', views.TreatmentPlant2Create.as_view(), name='treatment_plants_form2')
    ...
    path('', views.ActivityView.as_view(), name='greentech_list'),
    path('create', views.CreateActivityView.as_view(), name='greentech_create'),
    path('upload', views.UploadCSV, name='greentech_upload'),
